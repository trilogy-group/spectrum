# Spectrum Development with DF Devspaces
...
```bash
cd ..
devspaces bind spectrum
```
4. Grab some container info

```bash
devspaces info spectrum
```
...
```bash
devspaces exec spectrum
```

6. Run runtime dependencies:
```
rethinkdb &
redis-server &
```
...
## Running Spectrum via Docker-Compose file
...
### Requirements
 - The project should be cloned from https://github.com/trilogy-group/spectrum.git
...
- At this point you must be inside the docker container. From here, you can continue from section `6. Run runtime dependencies`.
